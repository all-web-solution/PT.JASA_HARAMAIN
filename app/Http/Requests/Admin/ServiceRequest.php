...
class ServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'route_name' => $isBusSelected ? 'required|array|min:1' : 'nullable|array',
            'route_name.*' => $isBusSelected ? 'required|string|max:255' : 'nullable',
            'route_price' => $isBusSelected ? 'required|array|min:1' : 'nullable|array',
            'route_price.*' => $isBusSelected ? 'required|numeric|min:0' : 'nullable',
    ...
    public function messages(): array
    {
        return [
            ...
            // 'rute_id.*.required' => 'Rute wajib dipilih untuk setiap transportasi darat.',
            'route_name.*.required' => 'Nama rute wajib diisi untuk setiap transportasi darat.',
            'route_name.*.string' => 'Format nama rute tidak valid.',
            'route_price.*.required' => 'Harga rute wajib diisi.',
            'route_price.*.numeric' => 'Harga rute harus berupa angka.',
            'route_price.*.min' => 'Harga rute tidak boleh kurang dari 0.',
