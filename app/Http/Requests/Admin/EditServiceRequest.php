...
//         $transportationTypes = $request->input('transportation', []); // Pastikan name di edit.blade 'transportation[]'
...
//         // =========================================================================
//         // 2. DEFINISI RULES (Disesuaikan untuk Update)
//         // =========================================================================
...
//             // File Tiket (Khusus Update: Nullable, tapi jika ada harus valid)
//             'tiket_berangkat.*' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:5120',
//             'tiket_pulang.*' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:5120',
...
//                 'array',
//                 function ($attribute, $value, $fail) use ($isHotelSelected, $request) {
//                     if (!$isHotelSelected)
//                         return;

//                     // Mengambil input nama_hotel via $request
...
//                 'array',
//                 function ($attribute, $value, $fail) use ($isDocumentSelected, $request) {
...
//                 },
//             ],
//             // File Dokumen (Update: Nullable)
//             'paspor_dokumen' => 'nullable|file|mimes:pdf,jpg,jpeg,png|max:5120',
//             'pas_foto_dokumen' => 'nullable|file|image|max:5120',
...
//             // File Handling Hotel (Update: Nullable)
//             'kode_booking_hotel_handling' => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:5120'],
//             'rumlis_hotel_handling' => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf,xls,xlsx', 'max:5120'],
//             'identitas_hotel_handling' => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:5120'],
...
//             // File Handling Bandara (Update: Nullable)
//             'paket_info' => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:5120'],
//             'identitas_koper_bandara_handling' => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf', 'max:5120'],
...
//                 $isPendampingSelected ? 'required' : 'nullable',
//                 'array',
//                 function ($attribute, $dates, $fail) use ($isPendampingSelected, $request) {
//                     if (!$isPendampingSelected)
//                         return;
...
//                 $isKontenSelected ? 'required' : 'nullable',
//                 'array',
//                 function ($attribute, $dates, $fail) use ($isKontenSelected, $request) {
//                     if (!$isKontenSelected)
//                         return;
...
//                 'array',
//                 function ($attribute, $dates, $fail) use ($isTourSelected, $request) {
//                     if (!$isTourSelected)
//                         return;
...
//                 $isMealSelected ? 'required' : 'nullable',
//                 'array',
//                 function ($attribute, $dates, $fail) use ($isMealSelected, $request) {
//                     if (!$isMealSelected)
//                         return;
...
//                 $isDoronganSelected ? 'required' : 'nullable',
//                 'array',
//                 function ($attribute, $dates, $fail) use ($isDoronganSelected, $request) {
//                     if (!$isDoronganSelected)
//                         return;
...
//         // =========================================================================
//         // 3. DEFINISI PESAN (Sama persis dengan referensi Store)
//         // =========================================================================
...
//             'paket_info.required' => 'File Paket Info wajib diupload.', // Note: Di update pesan ini mungkin tidak muncul jika file null
