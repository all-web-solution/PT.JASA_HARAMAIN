    ...
    <div class="service-create-container">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    <i class="bi bi-plus-circle"></i>Ubah type hotel
                </h5>
                <a href="{{ route('hotel.type.index') }}" class="btn btn-secondary">
                    <i class="bi bi-arrow-left"></i> Kembali
                </a>
            </div>

            <div class="card-body">
                <form action="{{ route('hotel.type.update', $type->id) }}" method="POST">
                    @csrf
                    @method('put')
                    ...
                    <div class="form-section">
                        <h6 class="form-section-title">
                            <i class="bi bi-building"></i> Data type Hotel
                        </h6>
                    ...
                    <button type="submit" class="btn btn-submit">
                        <i class="bi bi-check-circle"></i> Simpan perubahan type hotel
                    </button>
                </form>
            </div>
        </div>
