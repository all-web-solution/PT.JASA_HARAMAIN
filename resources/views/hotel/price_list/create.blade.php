            ...
            <div class="card-body">
                ...
                <form action="{{ route('hotel.price.store') }}" method="POST">
                    ...
                    <div class="form-section">
                        <h6 class="form-section-title"><i class="bi bi-building"></i> Data Harga Hotel</h6>
                            ...
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <select name="nama_hotel" class="form-control" id="nama_hotel_select" required>
                                        <option value="">-- Cari atau Tambah Hotel Baru --</option>
                                        @foreach ($hotels as $namaHotel)
                                            <option value="{{ $namaHotel }}"
                                                {{ old('nama_hotel') == $namaHotel ? 'selected' : '' }}>
                                                {{ $namaHotel }}
                                            </option>
                                        @endforeach
                                    </select>
