...
<div class="service-create-container">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">
                <i class="bi bi-plus-circle"></i>Edit Hotel {{ $priceList->nama_hotel }}
            </h5>
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="tanggal" required id="email" value="{{ $priceList->tanggal }}">
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_hotel"
                                       required  id="penanggung" value="{{ $priceList->nama_hotel }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tipe_kamar" required id="email" value="{{ $priceList->tipe_kamar }}">
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                                <label class="form-label">Harga</label>
                                <input type="text" class="form-control" name="harga" required id="email" value="{{ $priceList->harga }}">
                            </div>
                        </div>
                    </div>
                </div>
