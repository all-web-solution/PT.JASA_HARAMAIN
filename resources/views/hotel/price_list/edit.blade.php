    ...
    <div class="service-create-container">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title"><i class="bi bi-plus-circle"></i> Edit Hotel: {{ $priceList->nama_hotel }}</h5>
                            ...
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tanggal" id="tanggal"
                                        value="{{ $priceList->tanggal }}" required>
                                </div>
                            </div>
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <select name="nama_hotel" class="form-control" required>
                                        @foreach ($hotels as $namaHotel)
                                            <option value="{{ $namaHotel }}"
                                                {{ $priceList->nama_hotel == $namaHotel ? 'selected' : '' }}>
                                                {{ $namaHotel }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tipe_kamar" class="form-control" required>
                                        @foreach ($roomTypes as $tipe)
                                            <option value="{{ $tipe }}"
                                                {{ $priceList->tipe_kamar == $tipe ? 'selected' : '' }}>
                                                {{ $tipe }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="harga" id="harga"
                                        value="{{ $priceList->harga }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
