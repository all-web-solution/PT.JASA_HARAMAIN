                        ...
                        <div class="form-row">
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="checkin" required id="email">
                                </div>
                            </div>
                            <div class="form-col">
                                <div class="form-group">
                                    <label class="form-label">Checkout</label>
                                    <input type="date" class="form-control" name="checkout" required id="penanggung">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="room" required id="email">
                                </div>
                            </div>
                            <div class="form-col">
                                <div class="form-group">
                                    <label class="form-label">Star</label>
                                    <input type="text" class="form-control" name="star" required id="phone">
                                </div>
                            </div>
                        </div>
                    </div>
