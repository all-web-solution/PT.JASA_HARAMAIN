                        ...
                        <div class="form-row">
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama" required id="email" value="{{ $content->name }}">
                                </div>
                            </div>
                            <div class="form-col">
                                <div class="form-group">
                                    <label class="form-label">Harga</label>
                                    <input type="text" class="form-control" name="harga" required id="penanggung" value="{{ $content->price }}">
                                </div>
                            </div>
                        </div>
