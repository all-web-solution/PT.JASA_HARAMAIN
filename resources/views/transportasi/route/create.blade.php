...
<div class="service-create-container">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('transportation.car.detail', $transportation->id) }}" class="btn btn-secondary">
                <i class="bi bi-arrow-left"></i> Kembali
            </a>
        </div>

        <div class="card-body">
            <form action="{{ route('transportation.car.detail.store', $transportation->id) }}" method="POST">
                @csrf
