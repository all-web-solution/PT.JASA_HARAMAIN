    ...
    <div class="service-list-container">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title"><i class="bi bi-plus-circle"></i> Tambah Harga Tiket</h5>
                <a href="{{ route('price.list.ticket') }}" class="btn-secondary"><i class="bi bi-arrow-left"></i> Kembali</a>
            </div>

            <form action="{{ route('price.list.ticket.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="kelas" class="form-select @error('kelas') is-invalid @enderror" required>
                                    ...
                                    <option value="Ekonomi" {{ old('kelas') == 'Ekonomi' ? 'selected' : '' }}>Ekonomi
                                    </option>
