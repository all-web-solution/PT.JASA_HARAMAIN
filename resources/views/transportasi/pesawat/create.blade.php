...
<div class="service-create-container">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('transportation.plane.store') }}" method="POST">
                @csrf
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="asal" required id="email">
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="tanggal" required id="email">
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                                <label class="form-label">Maskapai</label>
                                <input type="text" class="form-control" name="maskapai" required id="phone">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="transit" required id="email">
                            </div>
                        </div>
                        <div class="form-col">
                            <div class="form-group">
                                <label class="form-label">Pax</label>
                                <input type="text" class="form-control" name="pax" required id="phone">
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="deskripsi" required id="email">
                            </div>
                        </div>
                    </div>
                </div>
