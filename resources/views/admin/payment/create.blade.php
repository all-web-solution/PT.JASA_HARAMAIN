...
@section('content')
    ...
    <div class="service-create-container">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.payment.stor') }}" method="POST">
                    @csrf
                        ...
                        <div class="form-row">
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <select name="order_id" class="form-control" id="customer-select">
                            ...
                            <div class="form-col">
                                <div class="form-group">
                                    <label class="form-label">Jumlah yang di bayarkan</label>
                                    <input type="text" class="form-control" name="total_harga" required id="total_harga"
                                        >
                                </div>
                            </div>
                        </div>
