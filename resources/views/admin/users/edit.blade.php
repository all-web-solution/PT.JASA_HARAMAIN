    ...
    <div class="service-create-container">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    <i class="bi bi-plus-circle"></i>Edit Karyawan {{ $user->name }}
                </h5>
                ...
                <form action="{{ route('user.update', $user->id) }}" method="POST">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-col">
                                <div class="form-group">
                                    <label class="form-label">Password <small>(kosongkan jika tidak ingin
                                            diubah)</small></label>
                            ...
                            <select name="role" class="form-control" required>
                                ...
                                @php
                                    $roles = [
                                        ...
                                        'hotel' => 'Hotel',
                                        'handling' => 'Handling',
                                        'transportasi & tiket' => 'Transportasi & Tiket',
                                        'visa dan acara' => 'Visa dan Acara',
                                        'reyal' => 'Reyal',
                                        'palugada' => 'Palugada',
                                        'konten dan dokumentasi' => 'Konten dan Dokumentasi',
                                    ];
                                @endphp
