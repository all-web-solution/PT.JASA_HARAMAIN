        ...
        <div class="card">
            ...
            <div class="search-filter-container">
                <div class="search-box">
                    ...
                    {{-- Hapus id="searchInput" karena JS dihapus --}}
                    <input type="text" class="form-control" placeholder="Cari (Belum aktif)...">
                </div>
                        ...
                        @else
                            @foreach ($orders as $order)
                                ...
                                <tr>
                                    ...
                                    <td data-label="Nama Pelanggan" class="text-center">
                                        {{-- PERBAIKAN N+1: Data sudah di-load --}}
