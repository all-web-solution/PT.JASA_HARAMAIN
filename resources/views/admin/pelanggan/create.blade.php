                                    ...
                                    <div class="form-col">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="nama_travel" name="nama_travel" value="{{ old('nama_travel') }}"
                                                required>
                                            @error('nama_travel')
                                    ...
                                    <div class="form-col">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select @error('status') is-invalid @enderror" id="status"
                                                ...
                                                <option value="active"
                                                    {{ old('status', 'active') == 'active' ? 'selected' : '' }}>Aktif
                                                </option>
                                                <option value="inactive"
                                                    {{ old('status') == 'inactive' ? 'selected' : '' }}>Non-Aktif</option>
                                            </select>
                                            @error('status')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
