                                ...
                                <div class="form-group">
                                    ...
                                    <select name="service_id" class="form-control" required>
                                        ...
                                        @foreach ($services as $service)
                                            <option value="{{ $service->id }}">{{ $service->unique_code }} -
                        ...
                        <div class="form-row">
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="pj" required id="pj">
                                </div>
                            </div>
                            <div class="form-col">
                                <div class="form-group">
                                    <label class="form-label">Jumlah Kebutuhan</label>
                                    <input type="number" class="form-control" name="jumlah" required id="jumlah">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control" required>
                                        ...
                                        <option value="tahap produksi">Tahap Produksi</option>
