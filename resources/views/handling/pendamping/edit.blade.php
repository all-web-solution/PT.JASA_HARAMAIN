...
@section('title', 'Form menambah pendamping')
@section('content')
<style>
    :root {
...
<div class="service-create-container">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">
                <i class="bi bi-plus-circle"></i>Ubah data Pendamping
            </h5>
            <a href="{{ route('handling.pendamping.index') }}" class="btn btn-secondary">
                <i class="bi bi-arrow-left"></i> Kembali
            </a>
        </div>

        <div class="card-body">
            <form action="{{ route('handling.pendamping.update', $guide->id) }}" method="POST">
                @csrf
                @method('put')
