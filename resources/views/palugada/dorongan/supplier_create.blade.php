            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('dorongan.supplier.show', $content->id) }}" class="btn btn-sm" style="background-color: var(--haramain-light); color: var(--haramain-primary);">
                ...
                <div class="card-body">
                    ...
                    --}}
                    <form action="{{ route('dorongan.supplier.store', $content->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
