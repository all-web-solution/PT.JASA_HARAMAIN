...
@section('title', 'Detail Order Dorongan')
...
@section('content')
    <div class="service-list-container">
        ...
        {{-- Asumsi Controller mengirim variabel $dorongan (Model DoronganOrder) --}}
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('dorongan.customer') }}" class="btn-secondary">
                    <i class="bi bi-arrow-left"></i> Kembali
                </a>
            </div>
            <div class="card-body">
                @if ($dorongan->service?->pelanggan)
                    @php
                        $service = $dorongan->service;
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    ...
                    <div>
                        <span class="title-text">Detail Order Dorongan: {{ $dorongan->dorongan?->name ?? 'N/A' }}</span>
                    </div>
                </h5>
                <a href="{{ route('dorongan.customer.edit', $dorongan->id) }}" class="btn-action"> {{-- route('dorongan.edit', $dorongan->id) --}}
            ...
            {{-- Logika Badge Status --}}
            @php
                $status = strtolower($dorongan->status);
                $statusClass = '';
                    ...
                    <div class="info-card">
                        ...
                        <div class="content">
                            <div class="info-item">
                                ...
                                <span class="value">{{ $dorongan->dorongan?->name ?? 'N/A' }}</span>
                            </div>
                            <div class="info-item">
                                <span class="label">Jumlah</span>
                                <span class="value">{{ $dorongan->jumlah }}</span>
                            </div>
                            <div class="info-item">
                                <span class="label">Tanggal Pelaksanaan</span>
                                <span class="value"
                                    style="text-transform: none;">{{ \Carbon\Carbon::parse($dorongan->tanggal_pelaksanaan)->isoFormat('dddd, D MMMM Y') }}</span>
                            </div>
                            <div class="info-item">
                                <span class="label">Status</span>
                                <span class="value status-value">
                                    <span class="badge {{ $statusClass }}">{{ $dorongan->status }}</span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-card">
                        ...
                        <div class="content">
                            <div class="info-item">
                                ...
                                <span class="value">{{ $dorongan->supplier ?? '-' }}</span>
                            </div>
                            <div class="info-item">
