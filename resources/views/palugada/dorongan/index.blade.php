    ...
    <div class="service-list-container">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    <i class="bi bi-cart-check"></i>Daftar Dorongan
                </h5>
                <a href="{{ route('dorongan.create') }}" class="btn-add-new">
                                ...
                                <td>
                                    <div class="actions-container">
                                        ...
                                        <form id="delete-form-{{ $item->id }}"
                                            action="{{ route('dorongan.destroy', $item->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                        ...
                        @empty
                            <tr>
                                <td colspan="4" style="text-align:center; padding: 2rem;">
                                    Belum ada data permintaan dorongan.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        title: 'Anda Yakin?',
                        html: `Anda akan menghapus item: <strong>${itemName}</strong>. Aksi ini tidak bisa dibatalkan!`,
                        icon: 'warning',
