        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="fw-bold mb-0 title-responsive-create-travel" style="color: var(--haramain-primary);">
                            <i class="bi bi-plus-circle me-2"></i>Tambah Supplier wakaf  Baru
                        </h5>
                        <a href="{{ route('wakaf.supplier.show', $content->id) }}" class="btn btn-sm" style="background-color: var(--haramain-light); color: var(--haramain-primary);">
                ...
                <div class="card-body">
                    ...
                    --}}
                    <form action="{{ route('wakaf.supplier.store', $content->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
