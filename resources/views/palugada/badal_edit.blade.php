...
@section('title', 'Edit Order Badal')
    ...
    <div class="service-list-container">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    <i class="bi bi-person-check-fill"></i> Edit Order Badal
                </h5>
                {{-- Arahkan kembali ke detail badal --}}
                <a href="{{ route('badal.show', $badal->id) }}" class="btn btn-secondary">
                    <i class="bi bi-arrow-left"></i> Kembali
                </a>
            </div>

            {{-- Controller mengirim: $badal, $services, $statuses --}}
            <form action="{{ route('badal.update', $badal->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                                ...
                                <select id="service_id" name="service_id"
                                    ...
                                    @foreach ($services as $service)
                                        <option value="{{ $service->id }}"
                                            {{ old('service_id', $badal->service_id) == $service->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="name" class="form-label">Nama yang dibadalkan</label>
                                <input type="text" id="name" name="name"
                                    class="form-control @error('name') is-invalid @enderror" disabled
                                    value="{{ old('name', $badal->name) }}">
                                @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="tanggal_pelaksanaan" name="tanggal_pelaksanaan"
                                    ...
                                    value="{{ old('tanggal_pelaksanaan', \Carbon\Carbon::parse($badal->tanggal_pelaksanaan)->format('Y-m-d')) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" name="status"
                                    ...
                                    @foreach ($statuses as $status)
                                        <option value="{{ $status }}"
                                            {{ old('status', $badal->status) == $status ? 'selected' : '' }}>
                                            {{ $status }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="supplier" name="supplier"
                                    ...
                                    value="{{ old('supplier', $badal->supplier) }}">
                                @error('supplier')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" id="harga_dasar" name="harga_dasar"
                                    ...
                                    value="{{ old('harga_dasar', $badal->harga_dasar) }}">
                                @error('harga_dasar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" id="harga_jual" name="harga_jual"
                                    ...
                                    value="{{ old('harga_jual', $badal->harga_jual) }}">
                                @error('harga_jual')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="price" class="form-label">Harga (Lama/Estimasi)</label>
                                <input type="number" step="0.01" id="price" name="price"
                                    class="form-control @error('price') is-invalid @enderror" disabled
                                    value="{{ old('price', $badal->price) }}">
                                @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
